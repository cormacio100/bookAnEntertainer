...
ALLOWED_HOSTS = ['localhost','127.0.0.1','https://ab9d84f3.ngrok.io']    #   INCLUDE NGROK TO ALLOW PAYPAL TO WORK
...
PAYPAL_NOTIFY_URL = 'https://ab9d84f3.ngrok.io/to-ngrok-or-not-to-ngrok/'   #   ON LOCALHOST NEED TO RUN ngrok AND COPY
